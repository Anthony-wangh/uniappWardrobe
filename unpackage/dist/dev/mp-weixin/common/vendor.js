...
function initRuntimeSocketService() {
  const hosts = "192.168.42.34,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_V0pQXU";
...
const globalStyle = {
  ...
  navigationBarBackgroundColor: "#ccd3ff",
...
const b = true, E = "mp-weixin", P = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = E, A = T('{"address":["127.0.0.1","192.168.42.34"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","D:/HBuilderX.4.45.2025010502/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"wardrobe","spaceId":"mp-4b3d4a3e-34ae-4a6b-9251-419f15c35843","clientSecret":"0UW72vSqT5uqsCchXIrIzA==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__FB9B52D";
} catch (e2) {
