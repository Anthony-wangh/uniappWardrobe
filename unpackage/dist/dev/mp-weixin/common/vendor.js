...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__FB9B52D",
    appName: "UniappWardrobe",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initRuntimeSocketService() {
  const hosts = "192.168.42.56,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_H_Sx9t";
...
const pages = [
  ...
  {
    path: "pages/addClothes/addClothes",
    style: {
      navigationBarTitleText: ""
    }
  },
  {
    path: "pages/addMatching/addMatching",
    style: {
      navigationBarTitleText: ""
    }
  },
  ...
  {
    path: "pages/publishPost/publishPost",
    style: {
      navigationBarTitleText: ""
    }
  },
  ...
  {
    path: "pages/settings/themeSetting",
    style: {
      navigationBarTitleText: ""
    }
  },
  {
    path: "pages/settings/faqSetting",
    style: {
      navigationBarTitleText: ""
    }
  },
  {
    path: "pages/settings/privacyPolicy",
    style: {
      navigationBarTitleText: ""
    }
  },
  {
    path: "pages/settings/categorySetting",
    style: {
      navigationBarTitleText: ""
    }
  },
  {
    path: "pages/settings/messageList",
    style: {
      navigationBarTitleText: ""
    }
  },
  ...
  list: [
    {
      ...
      text: "主页",
      iconPath: "/static/tabBarIcons/personal.png",
      selectedIconPath: "/static/tabBarIcons/personal-select.png"
    },
    {
      pagePath: "pages/wardrobe/wardrobe",
      text: "衣橱",
      iconPath: "/static/tabBarIcons/wardrode.png",
      selectedIconPath: "/static/tabBarIcons/wardrode-select.png"
    },
    {
      pagePath: "pages/matching/matching",
      text: "搭配",
      iconPath: "/static/tabBarIcons/matching.png",
      selectedIconPath: "/static/tabBarIcons/matching-select.png"
    },
    {
      pagePath: "pages/settings/settings",
      text: "设置",
      iconPath: "/static/tabBarIcons/setting.png",
      selectedIconPath: "/static/tabBarIcons/setting-select.png"
    }
  ],
  color: "#a9b7b7",
  selectedColor: "#8A6FDF",
  backgroundColor: "#ffffff",
  borderStyle: "black"
};
const e = {
...
const b = true, E = "mp-weixin", P = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = E, A = T('{"address":["127.0.0.1","192.168.42.56"],"servePort":7000,"debugPort":9000,"initialLaunchType":"remote","skipFiles":["<node_internals>/**","D:/HBuilderX.4.45.2025010502/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"uni-wardrobe","spaceId":"mp-5df80302-4973-4391-bd75-89493f11fa67","clientSecret":"qA3h7rCDWO6h+T9ja4wB5g==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__FB9B52D";
} catch (e2) {
