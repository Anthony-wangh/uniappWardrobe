...
const _sfc_main = {
  ...
  created() {
    ...
    common_vendor.index.getSystemInfo().then((result) => {
  ...
  methods: {
    ...
    initCanvas() {
      const context = common_vendor.index.createSelectorQuery().in(this);
    ...
    draw() {
      const context = common_vendor.index.createCanvasContext(this.canvasId, this);
      const transform = this.transform;
      const corner = this.corner;
      ...
      context.translate((transform.translate.x - corner.left + img.width / 2) * canvasZoom, (transform.translate.y - corner.top + img.height / 2) * canvasZoom);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    a: _ctx.src,
    b: _ctx.transformMeta,
    c: _ctx.image.width + "px",
    d: _ctx.image.height + "px",
    e: common_vendor.o(($event) => _ctx.setCutMode("lt")),
    f: common_vendor.o(($event) => _ctx.setCutMode("rt")),
    g: common_vendor.o(($event) => _ctx.setCutMode("rb")),
    h: common_vendor.o(($event) => _ctx.setCutMode("lb")),
    i: _ctx.view ? 1 : "",
    j: _ctx.showCtrlBorder ? 1 : "",
    k: _ctx.view && _ctx.circleView && _ctx.maskType !== "outline" ? 1 : "",
    l: common_vendor.s(_ctx.ctrlStyle),
    m: _ctx.canvasId
  }, _ctx.canvasId ? {
    n: _ctx.canvasId,
    o: _ctx.canvasId,
    p: _ctx.ctrlWidth * _ctx.canvasZoom + "px",
    q: _ctx.ctrlHeight * _ctx.canvasZoom + "px"
  } : {}, {
    r: _ctx.height,
    s: _ctx.width,
    t: _ctx.background,
    v: common_vendor.o((...args) => _ctx.start && _ctx.start(...args)),
    w: common_vendor.o((...args) => _ctx.move && _ctx.move(...args)),
    x: common_vendor.o((...args) => _ctx.end && _ctx.end(...args)),
    y: common_vendor.o((...args) => _ctx.end && _ctx.end(...args))
  });
}
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render]]);
wx.createComponent(Component);
//# sourceMappingURL=../../../.sourcemap/mp-weixin/components/nice-cropper/cropper.js.map
