...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    a: $data.target.width + "px",
    b: $data.target.height + "px",
    c: $data.transit ? 1 : "",
    d: $props.url,
    e: common_vendor.o((...args) => $options.imageLoad && $options.imageLoad(...args)),
    f: $data.transit ? 1 : "",
    g: $data.image,
    h: $data.transit ? 1 : "",
    i: $props.url,
    ...
    n: common_vendor.o((...args) => $options.rotateAngle && $options.rotateAngle(...args)),
    o: common_vendor.o((...args) => $options.onok && $options.onok(...args)),
    p: $props.url,
    q: $data.modeValue,
    r: $data.rotate
  };
...
if (typeof block0 === "function")
  block0(_sfc_main);
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-c759d1e7"]]);
wx.createComponent(Component);
//# sourceMappingURL=../../../../../.sourcemap/mp-weixin/uni_modules/ksp-cropper/components/ksp-cropper/ksp-cropper.js.map
