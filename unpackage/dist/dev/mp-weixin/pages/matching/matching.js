...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    r: $data.showDeleteModal
  }, $data.showDeleteModal ? {
    s: common_vendor.o((...args) => $options.closeDeleteModal && $options.closeDeleteModal(...args)),
    t: common_vendor.o((...args) => $options.deleteCategory && $options.deleteCategory(...args))
  } : {});
}
